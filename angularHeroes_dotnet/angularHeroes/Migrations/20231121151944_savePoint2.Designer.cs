...
namespace angularHeroes.Migrations
{
    ...
    [Migration("20231121151944_savePoint2")]
    partial class savePoint2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("angularHeroes.Models.HeroModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("angularHeroes.Models.Trainer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("angularHeroes.Models.Trainer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("angularHeroes.Models.HeroModel", b =>
                {
                    b.HasOne("angularHeroes.Models.Trainer", "Trainer")
                        .WithMany("Heroes")
